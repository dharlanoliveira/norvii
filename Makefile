.PHONY: persistence-config persistence-health persistence-integration persistence-migrate \
	persistence-migration-status persistence-reset persistence-stop persistence-up \
	persistence-verify
