...
export const portugueseTranslation = {
  ...
  chat: {
    ...
    starterQuestions: {
      processingAgents:
        "Como os agentes de tratamento se relacionam com o controlador e o operador na LGPD?",
      processingScope: "A quais operações de tratamento a LGPD se aplica?",
      fundamentalRights: "Quais direitos fundamentais a LGPD protege?",
      chapterContents: "Quais artigos estão no Capítulo I da LGPD?",
      publicBodies:
        "Quais órgãos públicos devem observar as normas gerais da LGPD?",
    },
